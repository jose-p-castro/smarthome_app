...
public class HouseAssembler {
    ...
    static public House toDomain(HouseFactory houseFactory, HouseDataModel houseDataModel) {
        ...
        LocationVO locationVO = getLocationVO(houseDataModel, doorVO, streetVO);

        // Create and return House domain object
        return houseFactory.createHouse(houseIDVO, locationVO);
    }

    private static LocationVO getLocationVO(HouseDataModel houseDataModel, DoorVO doorVO, StreetVO streetVO) {
        ...
        return new LocationVO(addressVO, gpsVO);
    }
