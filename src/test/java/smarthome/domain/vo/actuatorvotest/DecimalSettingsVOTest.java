...
class DecimalSettingsVOTest {
    ...
    void givenGivenInvalidSettings_WhenVOIsInstantiated_ThenShouldThrowIllegalArgumentException() {
        //Arrange
        String lowerLimit1 = "8.5";
        String upperLimit1 = "7.8";
        String precision1 = "0.1"; // Lower Limit > Upper Limit
        String lowerLimit2 = "8.5";
        String upperLimit2 = "8.5";
        String precision2 = "0.1"; // Lower Limit = Upper Limit
        String lowerLimit3 = "6.55";
        String upperLimit3 = "7.8";
        String precision3 = "0.1"; // Limits != precisions
        String lowerLimit4 = "6.55";
        String upperLimit4 = "7.83";
        String precision4 = "0"; // Precision = 0
        String lowerLimit5 = "6.55";
        String upperLimit5 = "7.83";
        String precision5 = "-0.02"; // Precision < 0
        String lowerLimit6 = "6.55";
        String upperLimit6 = "7.83";
        String precision6 = "1.54"; // Precision > 1
        String lowerLimit7 = "6.55";
        String upperLimit7 = "7.83";
        String precision7 = "1"; // Precision = 1
        String lowerLimit8 = "6.555";
        String upperLimit8 = "7.835";
        String precision8 = "0.01"; // Dif Limits > precision
