...
class IntegerSettingsVOTest {
    ...
    void ifLimitsAreInvalid_whenConstructorCalled_thenReturnsException() {
        //Arrange
        String lowerLimit1 = "10";
        String upperLimit1 = "0"; // Lower Limit > Upper Limit
        String lowerLimit2 = "10";
        String upperLimit2 = "10"; // Lower Limit = Upper Limit
    ...
    void ifUnparseableLimits_whenConstructorCalled_thenReturnsIllegalArgumentException() {
        //Arrange
        String lowerLimit1 = "teste";
        String upperLimit1 = "10";
        String lowerLimit2 = "10";
        String upperLimit2 = "teste";
        String lowerLimit3 = "teste";
        String upperLimit3 = "outro teste";
    ...
    void whenParametersAreValid_thenObjectIsCreated() {
        //Arrange
        String lowerLimit1 = "0";
        String upperLimit1 = "10";
        String lowerLimit2 = "-10";
        String upperLimit2 = "10";
