                                    ...
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell align="center"
                                                       sx={{fontWeight: 'bold', color: 'black', fontSize: '1rem'}}>Sensor
                                                Type</TableCell>
                                        </TableRow>
                                    </TableHead>
                                )}
                                    ...
                                    {paginatedLogs.length > 0 ? (
                                        paginatedLogs.map((log) => (
                                            <StyledTableRow key={log.logID}>
                                                ...
                                                <StyledTableCell align="center" data-label="Reading"
                                                                 sx={{color: 'black'}}>
                                                    {`${log.reading} ${log.unit}`}
                                                </StyledTableCell>
                                                <StyledTableCell align="center" data-label="Sensor Type"
                                                                 sx={{color: 'black'}}>
                                        ...
                                        <TableRow>
                                            <TableCell align="center" colSpan={3} sx={{color: 'black'}}>No logs
                                                available for the selected period.</TableCell>
                                        </TableRow>
                                    )}
                                </TableBody>
                            </Table>
